...
class Fight:
    def __init__(self):
        ...
        try:
            ...
            print("Введённый возраст не является верным. Обратите внимание,что возраст может быть только положительным целым числом. Выбран стандартный возраст: 25 лет")
            chosen_age1 = 25
        ...
        try:
            chosen_age2 = self.check_valid_age(chosen_age2)
        except:
            print(
